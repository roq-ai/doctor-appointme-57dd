        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Patient Name" text={data?.patient_name} />

                <FormListItem label="Patient Age" text={data?.patient_age} />

                <FormListItem label="Patient Gender" text={data?.patient_gender} />

                <FormListItem label="Medical History" text={data?.medical_history} />

                <FormListItem label="Current Medication" text={data?.current_medication} />
